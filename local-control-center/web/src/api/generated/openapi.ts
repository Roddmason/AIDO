...
export type OverviewResponse = { "actionRequests": Array<ActionRequestRecord>; "agentProfiles": Array<JsonObject>; "agentRuns": Array<JsonObject>; "agentToolCalls": Array<JsonObject>; "agents": Array<CatalogAgentRecord>; "architectureDecisions": Array<ArchitectureDecisionRecord>; "artifacts": Array<ArtifactRecord>; "auditEvents": Array<AuditEventRecord>; "chats": Array<JsonObject>; "costUsage": Array<JsonObject>; "events": Array<EventRecord>; "evidencePackages": Array<EvidencePackageRecord>; "ideConnections": Array<JsonObject>; "jobRuns": Array<JobRunRecord>; "jobs": Array<JobRecord>; "mcpServers": Array<JsonObject>; "memoryItems": Array<JsonObject>; "modelCalls": Array<JsonObject>; "modelPolicies": Array<JsonObject>; "modelProviders": Array<JsonObject>; "nextSteps": Array<NextStepRecord>; "openDesign": JsonObject; "permissionDecisions": Array<JsonObject>; "permissionGrants": Array<JsonObject>; "pipelines": Array<JsonObject>; "policyRevisions": Array<JsonObject>; "projectTemplates": Array<ProjectTemplateRecord>; "projects": Array<ProjectRecord>; "promptTemplates": Array<JsonObject>; "providers": Array<ProviderRecord>; "riskRegister": Array<RiskRecord>; "runtimeWorkspaces": Array<WorkspaceRecord>; "sandboxProfiles": Array<JsonObject>; "security": JsonObject; "sessions": Array<JsonObject>; "skills": Array<JsonObject>; "teams": Array<TeamRecord>; "testResultRecords": Array<TestResultRecord>; "workflowRuns": Array<JsonObject>; "workflowSteps": Array<JsonObject>; "workflows": Array<JsonObject> };
