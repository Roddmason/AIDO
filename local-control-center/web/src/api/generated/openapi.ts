...
export type AgentRunRecord = { "createdAt": string; "id": string; "input": JsonObject; "jobId"?: JsonValue | string; "metadata": JsonObject; "output": JsonObject; "projectId": string; "status": string; "updatedAt": string; "workflowRunId"?: JsonValue | string; "workflowStepId"?: JsonValue | string };
...
export type ArtifactRecord = { "createdAt": string; "evidencePackageId"?: JsonValue | string; "hash"?: JsonValue | string; "id": string; "kind": string; "metadata": JsonObject; "path": string; "projectId": string };
...
export type AuditEventRecord = { "action": string; "actor": string; "createdAt": string; "id": string; "payload": JsonObject; "projectId"?: JsonValue | string; "target": string };
...
export type ChatRecord = { "createdAt": string; "id": string; "metadata": JsonObject; "projectId": string; "prompt": string; "sessionId"?: JsonValue | string; "status": string; "title": string; "updatedAt": string };
...
export type EventRecord = { "createdAt": string; "id": string; "jobId"?: JsonValue | string; "payload": JsonObject; "projectId"?: JsonValue | string; "type": string };
export type EvidenceCreateRequest = { "acceptanceChecklist"?: Array<JsonValue>; "agentId"?: JsonValue | string; "diffRefs"?: Array<JsonValue>; "logs"?: Array<JsonValue>; "projectId": string; "qaVerdict"?: string; "riskNotes"?: Array<JsonValue>; "screenshotRefs"?: Array<JsonValue>; "taskId"?: string; "testPlan"?: string; "testResultReports"?: Array<JsonObject>; "testResults"?: Array<JsonObject>; "workflowRunId"?: JsonValue | string };
...
export type EvidencePackageRecord = { "acceptanceChecklist": Array<JsonValue>; "agentId"?: JsonValue | string; "createdAt": string; "diffRefs": Array<JsonValue>; "id": string; "logs": Array<JsonValue>; "projectId": string; "qaVerdict": string; "riskNotes": Array<JsonValue>; "screenshotRefs": Array<JsonValue>; "taskId": string; "testPlan": string; "testResults": Array<JsonValue>; "workflowRunId"?: JsonValue | string };
...
export type IdeConnectionUpsertRequest = { "diagnostics"?: Array<JsonValue>; "editor"?: string; "openFiles"?: Array<JsonValue>; "projectId": string; "selection"?: JsonObject; "status"?: string; "terminalContext"?: JsonObject; "workspaceRoot"?: JsonValue | string };
...
export type JobMutationResponse = { "actionRequest"?: ActionRequestRecord | JsonValue; "actionRequests"?: Array<ActionRequestRecord>; "auditEvent"?: AuditEventRecord | JsonValue; "events"?: Array<EventRecord>; "job": JobRecord; "permissionGrant"?: JsonObject | JsonValue };
export type JobRecord = { "createdAt": string; "id": string; "idempotencyKey"?: JsonValue | string; "kind": string; "leaseExpiresAt"?: JsonValue | string; "leaseOwner"?: JsonValue | string; "payload": JsonObject; "projectId": string; "status": "queued" | "running" | "approval_required" | "completed" | "failed" | "cancelled"; "updatedAt": string; "workflowRunId"?: JsonValue | string; "workflowStepId"?: JsonValue | string };
export type JobRunRecord = { "completedAt"?: JsonValue | string; "id": string; "jobId": string; "metadata": JsonObject; "providerId"?: JsonValue | string; "startedAt": string; "status": string; "summary": string };
...
export type MemoryItemRecord = { "content": string; "createdAt": string; "createdByRunId"?: JsonValue | string; "hash": string; "id": string; "kind": string; "metadata": JsonObject; "projectId": string; "scope": string; "scopeId"?: JsonValue | string; "sourceRef": string; "supersedesId"?: JsonValue | string; "updatedAt": string; "validFrom": string; "version": number };
export type MemoryListResponse = { "memoryItems": Array<MemoryItemRecord> };
export type MemoryResponse = { "memoryItem": MemoryItemRecord };
export type ModelCallRecord = { "agentRunId"?: JsonValue | string; "completionTokens": number; "costUsd": number; "createdAt": string; "id": string; "metadata": JsonObject; "model": string; "modelPolicyId"?: JsonValue | string; "projectId": string; "promptTokens": number; "provider": string; "status": string };
...
export type NextStepRecord = { "createdAt": string; "dueAt"?: JsonValue | string; "id": string; "metadata": JsonObject; "owner": string; "priority": "low" | "medium" | "high" | "urgent"; "projectId": string; "sourceDecisionId"?: JsonValue | string; "sourceRiskId"?: JsonValue | string; "status": "planned" | "in_progress" | "blocked" | "completed" | "cancelled"; "title": string; "updatedAt": string };
...
export type OverviewResponse = { "actionRequests": Array<ActionRequestRecord>; "agentProfiles": Array<AgentProfileRecord>; "agentRuns": Array<AgentRunRecord>; "agentToolCalls": Array<AgentToolCallRecord>; "agents": Array<CatalogAgentRecord>; "architectureDecisions": Array<ArchitectureDecisionRecord>; "artifacts": Array<ArtifactRecord>; "auditEvents": Array<AuditEventRecord>; "chats": Array<ChatRecord>; "costUsage": Array<CostUsageRecord>; "events": Array<EventRecord>; "evidencePackages": Array<EvidencePackageRecord>; "ideConnections": Array<JsonObject>; "jobRuns": Array<JobRunRecord>; "jobs": Array<JobRecord>; "mcpServers": Array<JsonObject>; "memoryItems": Array<MemoryItemRecord>; "modelCalls": Array<ModelCallRecord>; "modelPolicies": Array<ModelPolicyRecord>; "modelProviders": Array<ModelProviderRecord>; "nextSteps": Array<NextStepRecord>; "openDesign": JsonObject; "permissionDecisions": Array<PermissionDecisionRecord>; "permissionGrants": Array<PermissionGrantRecord>; "pipelines": Array<PipelineRecord>; "policyRevisions": Array<PolicyRevisionRecord>; "projectTemplates": Array<ProjectTemplateRecord>; "projects": Array<ProjectRecord>; "promptTemplates": Array<JsonObject>; "providers": Array<ProviderRecord>; "riskRegister": Array<RiskRecord>; "runtimeWorkspaces": Array<WorkspaceRecord>; "sandboxProfiles": Array<SandboxProfileRecord>; "security": JsonObject; "sessions": Array<SessionRecord>; "skills": Array<JsonObject>; "teams": Array<TeamRecord>; "testResultRecords": Array<TestResultRecord>; "workflowRuns": Array<WorkflowRunRecord>; "workflowSteps": Array<WorkflowStepRecord>; "workflows": Array<WorkflowRecord> };
export type PermissionDecisionRecord = { "agentId"?: JsonValue | string; "command"?: JsonValue | string; "createdAt": string; "decision": string; "id": string; "path"?: JsonValue | string; "payload": JsonObject; "projectId"?: JsonValue | string; "reason": string; "riskLevel": string; "role"?: JsonValue | string; "tool"?: JsonValue | string; "workspaceId"?: JsonValue | string };
export type PermissionGrantRecord = { "actionRequestId"?: JsonValue | string; "agentId"?: JsonValue | string; "command"?: JsonValue | string; "consumedAt"?: JsonValue | string; "consumedByAgentRunId"?: JsonValue | string; "grantedAt"?: JsonValue | string; "grantedBy"?: JsonValue | string; "id": string; "jobId"?: JsonValue | string; "path"?: JsonValue | string; "payload": JsonObject; "permissionDecisionId"?: JsonValue | string; "projectId"?: JsonValue | string; "reason": string; "revokeReason"?: JsonValue | string; "revokedAt"?: JsonValue | string; "revokedBy"?: JsonValue | string; "status": string; "tool"?: JsonValue | string };
...
export type PipelineRecord = { "chatId"?: JsonValue | string; "createdAt": string; "id": string; "metadata": JsonObject; "projectId": string; "sessionId"?: JsonValue | string; "stages": Array<JsonObject>; "status": string; "title": string; "updatedAt": string };
...
export type ProjectResponse = { "auditEvent"?: JsonObject | JsonValue; "project": ProjectRecord };
...
export type SandboxProfileMutationResponse = { "policyRevision"?: JsonValue | PolicyRevisionRecord; "sandboxProfile": SandboxProfileRecord };
...
export type SessionRecord = { "createdAt": string; "id": string; "metadata": JsonObject; "name": string; "projectId": string; "status": string; "teamId"?: JsonValue | string; "updatedAt": string };
...
export type TestResultRecord = { "command": string; "createdAt": string; "durationMs"?: JsonValue | number; "evidencePackageId": string; "id": string; "metadata": JsonObject; "outputRef"?: JsonValue | string; "projectId": string; "status": string };
...
export type WorkflowRunRecord = { "completedAt"?: JsonValue | string; "id": string; "metadata": JsonObject; "projectId": string; "startedAt": string; "status": string; "workflowId": string };
...
export type WorkflowStepRecord = { "agentProfileId"?: JsonValue | string; "createdAt": string; "id": string; "input": JsonObject; "metadata": JsonObject; "name": string; "output": JsonObject; "projectId": string; "status": string; "updatedAt": string; "workflowId": string; "workflowRunId": string };
...
export type WorkspaceArchiveResponse = { "evidencePackage": JsonObject; "workspace": WorkspaceRecord };
export type WorkspaceRecord = { "archivedAt"?: JsonValue | string; "createdAt": string; "id": string; "isolationType": "directory" | "git_worktree"; "metadata": JsonObject; "ownerAgentId": string; "path": string; "projectId": string; "status": string; "taskId": string; "updatedAt": string; "workflowRunId"?: JsonValue | string; "workflowStepId"?: JsonValue | string };
