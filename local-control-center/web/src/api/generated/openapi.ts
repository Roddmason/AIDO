...
export type EventRecord = { "createdAt": string; "id": string; "jobId"?: null | string; "payload": JsonObject; "projectId"?: null | string; "type": string };
export type EvidenceCreateRequest = { "acceptanceChecklist"?: Array<JsonValue>; "agentId"?: null | string; "diffRefs"?: Array<JsonValue>; "logs"?: Array<JsonValue>; "projectId": string; "qaVerdict"?: string; "riskNotes"?: Array<JsonValue>; "screenshotRefs"?: Array<JsonValue>; "taskId"?: string; "testPlan"?: string; "testResultReports"?: Array<JsonObject>; "testResults"?: Array<JsonObject>; "workflowRunId"?: null | string };
...
export type ProjectCreateRequest = { "createDirectory"?: boolean; "metadata"?: JsonObject; "name"?: null | string; "path"?: null | string; "templateId"?: null | string };
...
export type WorkspaceAllocateRequest = { "agentId": string; "baseBranch"?: string; "isolationType"?: "directory" | "git_worktree"; "projectId": string; "reason"?: string; "taskId": string; "workflowRunId"?: null | string; "workflowStepId"?: null | string };
