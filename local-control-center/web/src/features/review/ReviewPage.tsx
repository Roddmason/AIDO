...
import { REVIEW_COLUMNS, buildReviewItems, groupReviewItems, requiresPatchEvidenceGate } from './model';
...
export function ReviewPage({
	...
	const columnCopy: Record<ReviewColumnId, { title: string; emptyTitle: string; emptyBody: string }> = {
		needs_review: {
