...
export type ModelCallRecord = { "agentRunId"?: null | string; "completionTokens": number; "costUsd"?: null | number; "createdAt": string; "id": string; "metadata": JsonObject; "model": string; "modelPolicyId"?: null | string; "projectId": string; "promptTokens": number; "provider": string; "status": "planned" | "completed" | "failed" | "blocked" | "unavailable" };
...
export type RuntimeProviderStatus = { "authenticated"?: boolean; "available": boolean; "canEditWorkspace"?: boolean; "canRunPrompt"?: boolean; "canRunVersionCheck"?: boolean; "capabilities"?: Array<string>; "configurationWarnings"?: Array<string>; "configured": boolean; "detected"?: boolean; "detectedCommand"?: null | string; "displayName": string; "executable": boolean; "healthCheckedAt"?: null | string; "healthStatus"?: string; "id": string; "installed"?: boolean; "kind": "api" | "gateway" | "local" | "cli" | "manual"; "lastError"?: string; "reason": string; "requiredConfiguration"?: Array<string>; "requiresApproval"?: boolean; "safety"?: RuntimeProviderSafety; "version"?: null | string };
...
export type TestPromptRecord = { "error"?: null | string; "latencyMs": number; "model": string; "ok": boolean; "providerId": string; "sample"?: string; "totalTokens"?: number; "usageSource"?: string };
...
export type ThreadBudgetUsedRecord = { "callCount": number; "capScope"?: null | string; "costStatus": "actual" | "estimated" | "mixed" | "unknown"; "perRunCapUsd"?: null | number; "usedUsd"?: null | number };
...
export type ThreadTokenSummaryRecord = { "callCount": number; "knownCalls": number; "tokenStatus": "actual" | "partial" | "unknown" | "none"; "totalTokens": number; "unknownCalls": number };
...
export type UsageSummaryRecord = { "actualCostUsd"?: null | number; "byProvider": Array<UsageSummaryProvider>; "estimatedCostUsd": number; "totalTokens": number };
