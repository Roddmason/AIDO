...
export type DevOpsAgentRunRequest = { "buildScripts"?: Array<string>; "dockerHealthcheck"?: boolean; "metadata"?: JsonObject; "projectId": string; "taskId"?: string; "workspaceId": string };
...
export type RuntimeProviderConfigurationRecord = { "configured": boolean; "displayName": string; "id": string; "kind": "api" | "gateway" | "local" | "cli" | "manual"; "missing": Array<string>; "reason": string; "status": "configured" | "configuration_required"; "variables": Array<RuntimeProviderConfigurationVariable> };
...
export type SecurityAgentRunResponse = { "agentRun": AgentRunRecord; "contract": SecurityAgentContract; "dependencyFiles": Array<JsonObject>; "evidencePackage": JsonObject; "filesScanned": Array<JsonObject>; "findings": Array<JsonObject>; "findingsArtifact": JsonObject; "job": JsonObject; "modelAnalysis"?: JsonObject | null; "reason": string; "status": string; "verdict": string; "workspace": JsonObject };
...
export type WorkflowRunRecord = { "completedAt"?: null | string; "id": string; "metadata": JsonObject; "projectId": string; "startedAt": string; "status": "running" | "completed" | "failed" | "cancelled" | "runtime_unavailable" | "qa_failed" | "evidence_ready" | "approved_for_integration" | "promotion_failed" | "promoted_to_branch" | "pr_created"; "workflowId": string };
