 ...
 * variables and the per-runtime healthcheck action. Extracted verbatim from the gateway container
 * so the container stays a thin orchestrator; secrets are always passed through `redactVisibleSecret`.
 */
